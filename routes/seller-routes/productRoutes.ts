...
productRoutes.post('/addProduct',verifyToken,authorizeRole("Seller"),productController.addProduct)
...
productRoutes.put('/updateProduct/:_id',verifyToken,authorizeRole("Seller"),productController.updateProduct)
...
productRoutes.post("/uploaduserimage", upload.single('recfile'), uploadToCloudinary("user_image"));
